...
struct AndroidTarget { QString id; QString api; QString arch; QString state="stopped"; int pid=-1; };
...
private:
    ...
    QString m_arch,m_kernel; bool m_kvm=false,m_qemu=false,m_emulator=false;
};
